...
Во класата Form1.cs го креираме текот на играта и нејзините опции. За почеток, чуваме листа од нивоа и една променлива која ни 
кажува кое е моменталното ниво, како и бројот на загинувања во текот на целата игра, кои ги прикажуваме во текот на играњето. Имаме и два тајмери, од кои првиот ги движи објектите, проверува судири и дали сме го поминале нивото, а вториот ги исцртува и придвижува објектите се додека не заврши играта. Исто така се имплементирани и опциите за паузирање на играта и на звукот при притискиње на соодветните букви на тастатурата.
